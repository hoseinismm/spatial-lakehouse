...
public class newo {
    ...
    public static void main(String[] args) throws IOException {
        ...
        item7.put("value", 65);
        item7.put("category", "normal");
        data.add(item7);

        Map<String, Object> item8 = new HashMap<>();
        item8.put("value", 75);
        item8.put("category", "special");
        data.add(item8);
        ...
        item10.put("value", 95);
        item10.put("category", "normal");
        data.add(item10);

        Map<String, Object> item11 = new HashMap<>();
        item11.put("value", 105);
        item11.put("category", "special");
        data.add(item11);

        Map<String, Object> item12 = new HashMap<>();
        item12.put("value", 115);
        data.add(item12);

        Map<String, Object> item13 = new HashMap<>();
        item13.put("value", 125);
        item13.put("category", "normal");
        data.add(item13);

        Map<String, Object> item14 = new HashMap<>();
        item14.put("value", 135);
        item14.put("category", "special");
        data.add(item14);
